...
PyObject * predict(perceptron_model *self, PyObject *args) {
	...
	return PyInt_FromLong(self->perc.predict(instance));
}
...
initperceptron_model(void)
{
	...
	m = Py_InitModule3("perceptron_model", module_methods,
		"perceptron module that creates an extension type.");
