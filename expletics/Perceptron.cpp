...
Perceptron::Perceptron(int array_dims, double _learningRate, int _maxIter)
{
...
void Perceptron::train(std::vector<std::vector<double>> _inputs, std::vector<int> _labels) {
	inputs = _inputs;
	labels = _labels;
