...
//}
//
//PyObject* linearRegression(PyObject *self, PyObject *args)
//{
//	PyObject *list_x;
//	PyObject *list_y;
//	PyArg_UnpackTuple(args, "ref", 1, 2, &list_x, &list_y);
//	PyObject* equation = calculate_linear_regression(list_x, list_y);
//	Py_DECREF(list_x);
//	Py_DECREF(list_x);
//	return equation;
//}
...
//PyObject* score(PyObject * X, PyObject * Y) {
//	return PyFloat_FromDouble(55.0);
//}
//const char *r = "INT";
//
//PyObject* getR(PyObject *pMod) {
//	return PyUnicode_FromString(r);
//}
//
//PyObject* setR(PyObject *pMod) {
//	r = "idk";
//	return PyUnicode_FromString(r);
//}
//
//PyMethodDef LinearRegressionMethods[] =
//{
//	{"getR", (PyCFunction)getR, METH_VARARGS, 0},
//	{"setR", (PyCFunction)setR, METH_VARARGS, 0},
//	{"LinearRegression", (PyCFunction)linearRegression, METH_VARARGS, 0},
//	{"score", (PyCFunction)score, METH_VARARGS, 0},
//	{NULL, NULL, NULL, NULL}
//};
//
//
...
//{
//	PyObject *m;
//	m = Py_InitModule("expletics.linear_model", LinearRegressionMethods);
//	if (m == NULL)
//		return;
//}
//
