...
static PyModuleDef linear_model_module = {
	PyModuleDef_HEAD_INIT,
	"linear_model_module", /* name of module */
	"Module that creates a linear model", /* module documentation, may be NULL */
	-1 /* size of per-interpreter state of the module,*/
};


PyMODINIT_FUNC
PyInit_linear_model(void)
{
	PyObject* m;
	...
	m = PyModule_Create(&linear_model_module);
